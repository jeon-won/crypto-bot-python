...
* Date: 2021. 6. 9.
* Author: Jeon Won
* Func: 다음 두 가지 조건 중 한 가지를 만족했을 때 텔레그램 메시지 전송
...
STOCH_LOWER_LIMIT = 0.2           # 스토캐스틱(stochastic) 하한선(Lower Limit): 현재가가 이 밑으로 떨어지면 알림
############################################################################################
