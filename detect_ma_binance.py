    ...
    try: 
        ...
        if(mod == 0):
            for ticker in tickers: 
                ...
                ma10_2 = get_prev_ma("BTC/USDT", INTERVAL, 10, 2)
                ma15_2 = get_prev_ma("BTC/USDT", INTERVAL, 15, 2)
                ...
                ma10_1 = get_prev_ma("BTC/USDT", INTERVAL, 10, 1)
                ma15_1 = get_prev_ma("BTC/USDT", INTERVAL, 15, 1)
                ma25_1 = get_prev_ma("BTC/USDT", INTERVAL, 25, 1)
                if(ma5_1 > ma10_1 > ma15_1 > ma25_1 or ma5_1 < ma10_1 < ma15_1 < ma25_1):
                    is_cross_1 = True

                print(now)
                print(ma5_2, ma10_2, ma15_2, ma25_2, is_cross_2)
                print(ma5_1, ma10_1, ma15_1, ma25_1, is_cross_1)
